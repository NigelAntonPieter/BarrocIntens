    ...
    internal class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                new Product { Id = 1,Code = "S234FREKT", Name= "Barroc Intens Italian Light",Product_categoryId = 2, Is_employee_only = true, Description = "Light", Price = 499, StockQuantity = 0, IsOrdered = false},
