    ...
    public class Maintenance_appointmentConfiguration : IEntityTypeConfiguration<Maintenance_appointment>
    {
        public void Configure(EntityTypeBuilder<Maintenance_appointment> builder)
        {
            builder.HasOne(ma => ma.Maintenance_Receipt)
                ...
                .IsRequired(false);
            builder.HasData(
                new Maintenance_appointment { Id = 1, CompanyId = 1, Remark = "Updated remark 1", DateAdded = DateTime.Now, DateOfMaintenanceAppointment = new DateOnly(2023, 12, 5), IsFinished = false, Maintenance_ReceiptId = null, Location = "Breda" },
